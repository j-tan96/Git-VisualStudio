    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Please Type a Valid Server IP Address and Press " +
                    "Enter: ");
                ...
                Console.WriteLine("Connected to the server, type text and press " +
                    "enter to send it to the srever, type < EXIT > to close.");
